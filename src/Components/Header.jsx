    ...
    <header className="bg-white shadow-md p-4 flex justify-between items-center fixed w-full top-0 z-10">
      ...
      <nav>
        <ul className="flex space-x-6">
          ...
          <li><a href="#" className="text-gray-700 hover:text-green-600 font-semibold">Produk</a></li>
          <li><a href="#" className="text-gray-700 hover:text-green-600 font-semibold">Tentang Kami</a></li>
          <li><a href="#" className="text-gray-700 hover:text-green-600 font-semibold">Kontak</a></li>
          <li>
            <a
              href="#"
